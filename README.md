...
ユーロヴィンテージファッションの美しさと着こなしを提案するWebサイト
...
### カラーパレット
- **Primary**: グレースケール (50-900)
- **Accent**: オレンジ系 (50-900)

### フォント
- **Sans**: Inter (本文)
- **Serif**: Playfair Display (見出し)

### コンポーネント
- `.btn-primary` - プライマリボタン
- `.btn-secondary` - セカンダリボタン
- `.card` - カードコンポーネント
- `.container-custom` - カスタムコンテナ
...
* **背景**
  ...
  * ヴィンテージファッションの中では比較的安く、誰でも着やすいアイテムが多く、長く着るという文化的価値も備えている。
...
* **コンセプト要素**：
  ...
  2. **ヴィンテージファッションの中では比較的安く、誰でも着られる**
