        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {stylingItems.map((item) => {
              // InstagramのURLかどうかをチェック
              const isInstagramUrl = item.imageUrl.includes('instagram.com');
              ...
              return (
                ...
                >
                  ...
                  >
                    {isInstagramUrl ? (
                      // InstagramのURLの場合は、プレースホルダー画像を表示
                      <div className="w-full h-80 bg-gray-200 flex items-center justify-center">
                        <div className="text-center">
                          ...
                          <p className="text-gray-500 text-sm">Instagram投稿</p>
                        </div>
                      </div>
                    ) : (
                      // 通常の画像URLの場合は、next/imageを使用
                      <Image
                        src={item.imageUrl}
                        alt={item.caption}
                        width={400}
